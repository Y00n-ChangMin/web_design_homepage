...
function tab_version2(){
    ...
    $(".tab_btn>a").click(function(){
        ...
        //tab_contents한칸 하위의 div를 모두 숨긴다.
...
function slide_move(){
    ...
    //가로방향 or 위아래
    //swing은 어차피 default니까 넣으나 안넣으나 똑같다.
    //easing default가 swing이다.
}